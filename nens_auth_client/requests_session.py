...
def get_session_for(remote_user: RemoteUser, valid_seconds: int = 60):
    """Return a requests.Session enriched with OAuth2 access tokens configured.
    ...
    # necessary. We do it here with a single check against this server's time.
